...
class WeeklyTradingCoachServiceTest {
    ...
    @InjectMocks
    private WeeklyTradingCoachService weeklyTradingCoachService;
    ...
    void buildReportForUserHighlightsReviewGapsAndWeakPayoffCapture() {
        ...
        WeeklyTradingCoachService.WeeklyCoachReport report = weeklyTradingCoachService.buildReportForUser(
                "user-1",
